...
@section('content_header')
    <div class="row">
        <div class="col-6">
            <h1 class="m-0 custom-heading">Lista de Origenes</h1>
        </div>
        <div class="col-6">
            <a href="{{ route('origen.create') }}" class="btn btn-primary" style="float: right;">Registrar Nuevo Origen</a>
        </div>
    </div>
@stop
                        ...
                        @foreach ($origenes as $row)
                            <tr>
                                ...
                                <td style="float:right;">
                                    <a href="{{ route('origen.edit', $row->id) }}" class="btn btn-outline-secondary"><i
                                            class="fa fa-sm fa-fw fa-pen"></i></a>
                                    <form action="{{ route('origen.destroy', $row->id) }}" method="post"
