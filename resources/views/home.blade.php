        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h5 class="mb-0">Acerca de: Sistema de Trazabilidad Documental</h5>
                </div>
                <div class="card-body">
                    
                    <h6 class="font-weight-bold">Período Legislativo 2023 - 2024</h6>
                    <p class="bg-light p-2 rounded">Dr. Raúl Luis Latorre Martínez</p>
