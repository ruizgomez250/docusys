...
@section('content_header')
    <div class="row">
        ...
        <div class="col-6">
            <a href="{{ route('tipodoc.create') }}" class="btn btn-primary" style="float: right;">Registrar Nuevo Documento</a>
        </div>
    </div>
@stop
                        ...
                        @foreach ($tipodocs as $row)
                            <tr>
                                ...
                                <td style="float:right;">
                                    <a href="{{ route('tipodoc.edit', $row->id) }}" class="btn btn-outline-secondary"><i
                                            class="fa fa-sm fa-fw fa-pen"></i></a>
                                    <form action="{{ route('tipodoc.destroy', $row->id) }}" method="post"
