...
class TipoDocRController extends Controller
{
    /**
     ...
     */
    public function edit(TipoDocR $tipodoc): View
    {
        try {
     ...
     */
    public function update(Request $request, TipoDocR $tipodoc)
    {
    ...
    public function destroy($id)
    {
        try {
            ...
            $tipoDoc = TipoDocR::findOrFail($id);
